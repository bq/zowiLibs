...
unsigned long int mouth[]={zero_code,one_code,two_code,three_code,four_code,five_code,six_code,seven_code,eight_code,
	...
	okMouth_code, xMouth_code,interrogation_code};
